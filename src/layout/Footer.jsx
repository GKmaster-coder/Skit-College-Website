    ...
    <footer className="relative bg-[#7A1F29] text-white pt-20 pb-10 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
        ...
        <div className="lg:col-span-2">
          ...
          <ul className={linkListClass}>
            ...
            <li><a href="#">Old Paper</a></li>
            <li><a href="#">Formats</a></li>
            <li><a href="#">Mid-term Result</a></li>
          </ul>
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="space-y-6 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-white uppercase tracking-wider text-xs mb-1">Campus</p>
                <p className="text-gray-200">Bahabalpur kanpur(D) - 209310 Uttar Pradesh</p>
                <p className="font-semibold mt-1">Ph: +91 78000 48009</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <FaMapMarkerAlt className="text-white mt-1 shrink-0" />
              <div>
                <p className="font-bold text-white uppercase tracking-wider text-xs mb-1">City Office</p>
                <p className="text-gray-200">1st Floor Krishna Dham Flat Kakadeo Kanpur - 208025</p>
                <p className="font-semibold mt-1">Ph: +91 8400341541</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="mailto:skitkd64@gmail.com" className="hover:text-white transition-colors">skitkd64@gmail.com</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-gray-300">
        ...
        <div className="text-center md:text-right space-y-1">
          ...
          <p className="text-xs text-gray-400">Designed by <span className="text-white font-medium">SKIT Faculty</span></p>
        </div>
      </div>
